...
class gps_data:
    ...
    def get_x_y(self):
        ...
        x_coordinate = (2250*np.median(cols) / image_width) + x_offset # check_col needs to be multiplied by real width of the table seen the camera
        y_coordinate = (1650*np.median(rows) / image_height) + y_offset # check_row needs to be multiplied by real height of the table seen   by the camera
        ...
        return x_coordinate, y_coordinate , self.theta
